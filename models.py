...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 18:25:20 2019
...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, embed_size, hidden_size, n_layers=1, dropout=0.1):
        ...
        self.embedding = nn.Embedding(
            input_size, embed_size, padding_idx=args.PAD_TOKEN
        )
        self.gru = nn.GRU(
...
class Attn(nn.Module):
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        return F.softmax(attn_energies, dim=1).unsqueeze(1)  # should it be dim=0???
...
class LuongAttnDecoderRNN(nn.Module):
    def __init__(self, attn_model, hidden_size, output_size, n_layers=1, dropout=0.1):
        ...
        # Define layers
        self.embedding = nn.Embedding(
            output_size, hidden_size, padding_idx=args.PAD_TOKEN
        )
